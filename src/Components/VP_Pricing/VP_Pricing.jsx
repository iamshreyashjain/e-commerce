export default function VP_Pricing(){
    return(
        <>
<div className="col-lg-12">
<center>
<h1>Pricing</h1>
<p className="col-lg-3 col-md-6 col-sm-6 col-6">
Quickly build an effective pricing table for your potential customers with this Bootstrap example. 
It’s built with default Bootstrap components and utilities with little customization.</p></center>
</div>
      ...
      <table className="table text-center">
        <thead>
          <tr>
            ...
            <th style={{width: '34%'}}>Free</th>
            <th style={{width: '34%'}}>Pro</th>
